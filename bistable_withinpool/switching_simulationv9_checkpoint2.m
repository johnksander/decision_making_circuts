...
basedir = '/Users/chewie/Desktop/work/ACClab/rotation/project';
addpath(fullfile(basedir,'helper_functions'))

%doesn't work: spikerate is way too high
...
Td = .45;%synaptic depression time constant, seconds
...
switch current_pulse
    case 'on'
        pulse_current = 0.2e-9; %below like, .3 or something it oscilates 
        pulse_params = {celltype.pool_stay,pulse_current,1,1.2};
