...
W(W > 0 & EtoE) = .25; %watch out for how this is selected (W ~=0) if you add noise or something
%--------------------------------------------------------------------------
...
b = NaN(pool_options.num_cells,1);
b(celltype.excit) = 1e-9;
b(celltype.inhib) = 1.5e-9;%increase adaptation current by max value, nano amps 
...
%                 celltype.pool_stay,5e-9,3,5}; %logical, current, start, end
