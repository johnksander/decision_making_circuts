...
W(W > 0 & ItoE) = .1; %watch out for how this is selected (W ~=0) if you add noise or something
W(W > 0 & EtoI) = .05; %watch out for how this is selected (W ~=0) if you add noise or something
W(W > 0 & EtoE) = .2; %watch out for how this is selected (W ~=0) if you add noise or something
%--------------------------------------------------------------------------
