...
%--------------------------------------------------------------------------
%----current and noise--------
%current_val = .2e-9; %applied current in nano amps
%noise_sigma = 2e-12; %noise variance in picoamps
current_val = 0e-9; %applied current in nano amps
noise_sigma = 0e-12; %noise variance in picoamps
...
Td = .15;%synaptic depression time constant, seconds
...
switch current_pulse
    case 'on'
        ...
        pulse_current = .2e-9; % 1 still works, actually turns off state
