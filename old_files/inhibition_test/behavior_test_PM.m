function behavior_test_PM(current_weight)
...
%original code: switching_simulationvPaulv3_test
...
equal_pools = 'on'; %'on' | 'off'  set switch & stay to have equal properties (b)
...
%--------------------------------------------------------------------------
%----current and noise--------
current_val(celltype.excit) = 100 * current_weight;
current_val(celltype.inhib) = 80;
noise_sigma = 400; %noise variance in picoamps
current_pulse = 'off'; %switch for adding transient pulses (also use for different excit & inhib currents)
%----cell connections---------
...
%----timecourse---------------
tmax = 100000; %simulation end, what's the unit here?
