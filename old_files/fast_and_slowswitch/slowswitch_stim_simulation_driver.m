...
config_options.sim_name = 'slowswitch_stimulus';
options = set_options(config_options);
options.tmax = 2500; %trial simulation time (s) 
Rstim = 30; %30 hz stimulus to Eswitch cells 
stimA = zeros(24,1) + Rstim; %let's do 2 runs per core at 2.5k seconds, try and get 10k switches 
