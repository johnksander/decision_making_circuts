...
%Now shooting for a model which switches slowly (if at all) when all 
%things are equal. Adding a stimulus should give quick switching. This
%gives nice spikerates too
...
% W(W > 0 & EtoE) = .0675 * .55;   %.0675 * 1
% W(W > 0 & ItoE) = (4.15 * .075);    %(4.15 * .15)
% W(W > 0 & EtoI) = .26 * 1.25;    %.25
W(W > 0 & EtoE) = .0675 * .6;   %.0675 * 1
W(W > 0 & ItoE) = (4.15 * .075);    %(4.15 * .15)
W(W > 0 & EtoI) = .35;    %.26 * 1.25
