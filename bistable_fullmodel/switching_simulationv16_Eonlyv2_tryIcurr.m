...
%tried adding some inhibitory current, seems to prevent alternate pool from
%switching on- would probably have to adjust some weights 
...
W(W > 0 & EtoE) = .25;
W(W > 0 & ItoE) = 5; 
W(W > 0 & EtoI) = .075; %changed since v16
...
%ONLY EXCITATORY 
Iapp(celltype.inhib,:) = Iapp(celltype.inhib,:) + Icurrent;
%ADDING INHIB
