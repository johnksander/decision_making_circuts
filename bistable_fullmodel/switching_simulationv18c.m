...
%the E-I cells are 4:1 count in this. The weights are unchanged
%proportionally, but ItoE connection probability is now 50% instead of 100%. This gives really nice switching behavior
