...
%init_state = 1000; %this is so dumb...
timepoint_idx = 1;
...
%     if timepoint_idx < init_state
%         %         ext_spikes(celltype.excit & celltype.pool_stay) = ...
%         %             poissrnd(200 * timestep,sum(celltype.excit & celltype.pool_stay),1);
%         ext_spikes(celltype.excit & celltype.pool_switch) = 0;
%         ext_spikes(celltype.inhib & celltype.pool_stay) = 0;
%     else
%         stim_spikes = timepoint_stimulus(stim_info,state);
%         ext_spikes = ext_spikes + stim_spikes;
%     end
