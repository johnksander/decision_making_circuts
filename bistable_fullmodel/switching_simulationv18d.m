...
%Alternate parameterization, and the E-I cells are 4:1 count in this.
%ItoE connection probability is now 50% instead of 100%. Weights for E-I
%are increased, I-E decreased. This was in response to simulation where Inhib noise always preceeded switches.
%weights for E-E also decreased, nice ~20hz exciatable now.
...
W(W > 0 & EtoE) = .0675;   %(.125 / 1.85);
W(W > 0 & ItoE) = 4.15;    %(20 / 4.8); 
W(W > 0 & EtoI) = .075;    %(.0375 * 2); 
...
switch current_pulse
    case 'on'
        ...
        pulse_current = .3e-9; 
        pulse_params = {celltype.pool_stay & celltype.excit,pulse_current,ptime_stay(1),ptime_stay(2);...
            celltype.pool_switch & celltype.excit,pulse_current,ptime_switch(1),ptime_switch(2);...
            celltype.pool_stay & celltype.excit,pulse_current,2.5,2.55;...
            celltype.pool_stay & celltype.excit,pulse_current,8,8.05;...
            celltype.pool_switch & celltype.excit,pulse_current,12.1,12.15}; %logical, current, start, end
