...
switch do_config
    case 1
        options.ItoE = 1.2904; options.EtoI = 0.1948; Rstim = 75/2; options.stim_targs = 'Eswitch';
    case 2
        options.ItoE = 1.2877; options.EtoI =  0.1734; Rstim = 100; options.stim_targs = 'Estay';
    case 3
        options.ItoE = 0.8069; options.EtoI = 0.2067; Rstim = 49.7632/2; options.stim_targs = 'Eswitch';
    case 4
    ...
    case 7
        options.ItoE = 0.2800; options.EtoI = 0.4228; Rstim = 47.0955/2; options.stim_targs = 'Eswitch';
    case 8
