...
% case 1
%     options.ItoE = 1.2904; options.EtoI = 0.1948; Rstim = 75 *.25; stim_targs = 'Eswitch';
% case 2
%     options.ItoE = 1.2877; options.EtoI =  0.1734; Rstim = 100; stim_targs = 'Estay';
% case 3
%     options.ItoE = 0.8069; options.EtoI = 0.2067; Rstim = 49.7632 *.25; stim_targs = 'Eswitch';
% case 4
%     options.ItoE = 0.7936; options.EtoI = 0.1878; Rstim = 59.2903; stim_targs = 'Estay';
% case 5
%     options.ItoE = 0.3679; options.EtoI = 0.2737; Rstim = 30.0436/2; stim_targs = 'Eswitch';
% case 6
%     options.ItoE = 0.3161; options.EtoI = 0.2482; Rstim = 175; stim_targs = 'Estay';
% case 7
%     options.ItoE = 0.2800; options.EtoI = 0.4228; Rstim = 47.0955 *.25; stim_targs = 'Eswitch';
% case 8
%     options.ItoE = 0.2355; options.EtoI = 0.4250; Rstim = 175; stim_targs = 'Estay';
% case 9
%     options.ItoE = 0.2921; options.EtoI = 0.6927; Rstim = 45/2; stim_targs = 'Eswitch';
% case 0
%     options.ItoE = 0.2119; options.EtoI = 0.6799; Rstim = 175; stim_targs = 'Estay';
