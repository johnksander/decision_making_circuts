...
Tau_ext(celltype.excit) = 5e-3;%3.5e-3; % was 2e-3
Tau_ext(celltype.inhib) = 2e-3; % was 5e-3;
initGext = 10e-9; %noisy conductance initialization value, nano Siemens
deltaGext = 1e-9 * 2.75;%increase noisy conducrance, nano Siemens
Rext = 150; %!! 1540; %poisson spike train rate for noise, Hz
warning('tauExt-E, deltaGext,Rext all changed right now')
