...
fig_dir = '/Users/ksander/Desktop/work/ACClab/rotation/project/Results/change_switchspeed';
fig_dir = fullfile(fig_dir,'Xcorr_analysis');
fig_fn = 'switching_Xcorr_full';
name4plots = 'basic_switch'; %added to basic fig directory, distingish different timecourse plots etc
...
Xcor_method = 'coeff'; %  'unbiased' | 'coeff'
...
switch how2load
    case 'txtdump'
        ...
        %ensure this is consistent with make_datafile() as well!! 
        Estay = 1;
        Istay = 2;
        Eswitch = 3;
        Iswitch = 4;
...
for simidx = 1:num_sims
    ...
    for XCidx = 1:num_Xcors
        ...
        [Rcells{XCidx,simidx},laginds] = xcorr(curr_data{1},curr_data{2},Xcor_method); %do Xcorr
    end
end
